...
const skills = [
  ...
  { name: 'Ethereum', level: 5, path: '/img/icons/ethereum.png'},
  { name: 'Hyperledger', level: 4, path: '/img/icons/hyperledger.png'},
  { name: 'EOS', level: 4, path: '/img/icons/eos.png'},
  { name: 'Biance', level: 4, path: '/img/icons/binance.png'},
  { name: 'Polygon', level: 4, class: 'devicon-polygon-plain colored'},
  { name: 'Truffle', level: 4, path: '/img/icons/truffle.png'},
  { name: 'Hardhat', level: 4, path: '/img/icons/hard-hat.png'},
  { name: 'Web3.js', level: 5, path: '/img/icons/web3.png'},
  { name: 'Ether.js', level: 3, path: '/img/icons/ethereum_1.png'},
  ...
  { name: 'IPFS', level: 4, path: '/img/icons/ipfs.svg'},
  { name: 'Bitcoin', level: 4, path: '/img/icons/bitcoin.png'},
  { name: 'Solana', level: 3, path: '/img/icons/solana.png'},
  { name: 'Meme', level: 4, path: '/img/icons/meme.png'},
  { name: 'NFT', level: 5, path: '/img/icons/nft.png'},
  { name: 'DAO', level: 4, path: '/img/icons/dao.png'},
  { name: 'Defi', level: 4, path: '/img/icons/defi.png'},
